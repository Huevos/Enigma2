...
class ConfigSelection(ConfigElement):
	...
	def getMulti(self, selected):
		...
		if self.graphic and config.usage.boolean_graphic.value and config.usage.selection_graphic.value and "menu_on" in switchPixmap and "menu_off" in switchPixmap:
